...
- RX-36 [(@DevWoody856)](https://github.com/DevWood856) demonstrates how to use `django-sendgrid-v5` to make a contact form for your web application: https://rx-36.life/post/create-a-contact-form-using-sendgrid-in-django/
